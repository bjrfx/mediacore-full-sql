...
const normalizeMediaItem = (item) => {
  ...
  return {
    ...
    thumbnailUrl: item.thumbnailUrl ?? item.thumbnail_url ?? item.thumbnail ?? item.thumbnail_path ?? '',
    thumbnail: item.thumbnail ?? item.thumbnailUrl ?? item.thumbnail_url ?? item.thumbnail_path ?? '',
